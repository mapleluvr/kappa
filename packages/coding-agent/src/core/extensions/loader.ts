...
import type { KeyId } from "@mapleluvr/kappa-tui";
import * as _bundledPiTui from "@mapleluvr/kappa-tui";
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@mapleluvr/kappa-tui": _bundledPiTui,
	...
	"@mapleluvr/kappa-coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@mapleluvr/kappa-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	...
	_aliases = {
		"@mapleluvr/kappa-coding-agent": piCodingAgentEntry,
		"@earendil-works/pi-agent-core": piAgentCoreEntry,
		"@mapleluvr/kappa-tui": piTuiEntry,

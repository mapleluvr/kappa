...
const OFFICIAL_PACKAGE_NAME = "@mapleluvr/kappa-coding-agent";
const OFFICIAL_APP_NAME = "kappa";
const OFFICIAL_CONFIG_DIR_NAME = ".kappa";
 ...
 * - this is the official Kappa distribution (not a further fork/rebrand)

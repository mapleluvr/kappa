...
import { APP_NAME, CONFIG_DIR_NAME, ENV_AGENT_DIR, ENV_PACKAGE_DIR, ENV_SESSION_DIR } from "../config.ts";
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|pi]   Update kappa, extensions, or model catalogs

import type { Component, Terminal, TUI } from "@mapleluvr/kappa-tui";
import { Container, getKeybindings, isViewportTUI, ScrollView, setKeybindings, Text } from "@mapleluvr/kappa-tui";

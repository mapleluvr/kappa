...
For TypeScript definitions in your project, inspect `node_modules/@mapleluvr/kappa-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@mapleluvr/kappa-coding-agent";

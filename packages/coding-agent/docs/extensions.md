...
| Package | Purpose |
|---------|---------|
| `@mapleluvr/kappa-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@earendil-works/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@mapleluvr/kappa-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import { isBashToolResult } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import { SessionManager } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@mapleluvr/kappa-tui";
...
```typescript
import { Box, Text } from "@mapleluvr/kappa-tui";
...
```typescript
import { withFileMutationQueue } from "@mapleluvr/kappa-coding-agent";
...
import { Type } from "typebox";
import { StringEnum } from "@earendil-works/pi-ai";
import { Text } from "@mapleluvr/kappa-tui";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import { createBashTool } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import { keyHint } from "@mapleluvr/kappa-coding-agent";
...
```typescript
import { Text, Component } from "@mapleluvr/kappa-tui";
...
import { matchesKey } from "@mapleluvr/kappa-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@mapleluvr/kappa-coding-agent";

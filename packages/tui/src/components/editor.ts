import { hasSlashCommandArgument, type AutocompleteProvider, type AutocompleteSuggestions } from "../autocomplete.ts";
...
export class Editor implements Component, Focusable {
	...
	private handleTabCompletion(): void {
		...
		if (this.isInSlashCommandContext(beforeCursor) && !hasSlashCommandArgument(beforeCursor)) {
